...
export default function Contacts() {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "670c9141-eead-4bcc-969e-cd3edd06fccd");
  ...
  return (
    <section className=" bg-background-color pb-9 text-green-tx">
      <div
        id="map"
        className="relative h-[300px] overflow-hidden bg-cover bg-[50%] bg-no-repeat"
      >
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d4901.4371756608325!2d25.628952920166082!3d43.07483328521163!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sbg!4v1723235940285!5m2!1sen!2sbg"
          width="100%"
          height={480}
          style={{ border: 0 }}
          allowFullScreen=""
      ...
      <div className="container px-6 md:px-12 ">
        <div className="block rounded-lg bg-[rgba(255,255,255,0.8)] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]  md:py-16 md:px-12 -mt-[100px] backdrop-blur-[30px] border border-gray-300">
              ...
              <form onSubmit={onSubmit}>
                <div className="relative mb-6" data-te-input-wrapper-init="">
                  ...
                  <input
                    ...
                    type="text"
                    name="name"
                    className="bg-navi peer block min-h-[auto] w-full rounded border-2  py-[0.32rem] px-3 leading-[1.6] outline-none  "
                    required
                  />
                </div>
                <div className="relative mb-6" data-te-input-wrapper-init="">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-6 grow">
                      ...
                      <p className="text-sm text-neutral-500">
                        WoodHeaven@gmail.com
                      </p>
                      <p className="text-sm text-neutral-500">+359 867847623</p>
                    </div>
                  </div>
                </div>
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:w-full lg:px-6 xl:w-6/12">
                ...
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:mb-0 md:w-6/12 md:px-3 lg:mb-12 lg:w-full lg:px-6 xl:w-6/12">
                  <div className="align-start flex">
                    ...
                    <div className="ml-6 grow">
                      ...
                      <p className="text-neutral-500"> (359) 431 2030</p>
                    </div>
                  </div>
                </div>
                <div className="w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:w-full lg:px-6 xl:mb-12 xl:w-6/12">
                  <div className="align-start flex">
                    ...
                    <div className="ml-6 grow">
                      ...
                      <p className="text-neutral-500"> +359 867847623</p>
                    </div>
                  </div>
                </div>
              </div>
